...
export default function CategoryCard({ item }) {
  return (
    ...
    >
      ...
      <div className='border-t border-zinc-200 group-hover:border-zinc-300 dark:border-zinc-700 dark:group- hover:border-zinc-600 text-sm text-zinc-500 dark:text-zinc-400 group-hover:text-black dark:group-hover:text-white grid grid-cols-2 gap-x-4 pt-4 mt-4'>
