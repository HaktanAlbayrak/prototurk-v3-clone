  ...
  return (
    <header
      className={classNames(
        'h-14 dark:bg-zinc-900/70 dark:border-zinc-700 transition-colors border-b border-zinc-200 flex items-center justify-between fixed top-0 left-0 w-full bg-white/70 backdrop-blur z-10',
        {
